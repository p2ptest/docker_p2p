...
int C2ndGetNetReLationCmd::ProcessCmd()
{
	...
	do
	{
		...
		if(nRet != 0)
		{
			...
			WriteRunInfo::WriteError("C2ndGetNetReLationCmd::ProcessCmd : Public(%s) get clusterId fail......", inet_ntoa(iaAddr));
			break;
		}
		...
		{
			m_outBody.m_nResult = -1;
			WriteRunInfo::WriteError("C2ndGetNetReLationCmd::ProcessCmd : Public(%s) get hostId fail......", inet_ntoa(iaAddr));
			break;
		}
		...
		{
			m_outBody.m_nResult = -1;
			WriteRunInfo::WriteError("C2ndGetNetReLationCmd::ProcessCmd : Public(%s) GetIsp fail", inet_ntoa(iaAddr));
			break;
		}
		...
		{
			m_outBody.m_nResult = -1;
			WriteRunInfo::WriteError("C2ndGetNetReLationCmd::ProcessCmd : Public(%s) CheckIfHotCluster fail", inet_ntoa(iaAddr));
			break;
		}
		...
		{
			m_outBody.m_nResult = -1;
			WriteRunInfo::WriteError("C2ndGetNetReLationCmd::ProcessCmd : Public(%s) GetCdnSrvInfo fail", inet_ntoa(iaAddr));
			break;
		}
		...
		{
			m_outBody.m_nResult = -1;
			WriteRunInfo::WriteError("C2ndGetNetReLationCmd::ProcessCmd : Public(%s) GetNetRelation fail", inet_ntoa(iaAddr));
			break;
		}
	}while(0);
